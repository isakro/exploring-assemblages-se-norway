...
splt1 <- fviz_ca_col(caallcats, col.col = "contrib",
             gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), repel = TRUE) +
  labs(colour = "Contribution to total inertia") +
  ggtitle("Supplementary material") +
  theme(legend.position = "bottom",
...
# A reviewer wanted artefact types combined irrespective of raw-material and 
# non-flint as supplementary column. I start by including it as a normal 
# column.
...
# supplementary column, following suggestion from the reviewer. 
