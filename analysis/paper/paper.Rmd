...
# Table 1. Overfiew of chronological framework.
...
Duration <- c("9500–8200 BCE", "8200–6300 BCE", "6300–4600 BCE", "4600–3800 BCE", "9200–8200 BCE", "8200–7000 BCE", "7000–5600 BCE", "5600–4500 BCE", "4500–3900 BCE")
...
kable(select(df, -framework), booktabs = TRUE, 
      caption = "Chronological framework. Glørstad's (2010) divison of phases reflects the more established framework, to which Reitan (2016) has recently suggested considerable changes.", 
      col.names = NULL) %>% 
pack_rows(index = c("Glørstad (2004)" = 4, "Reitan (2016)" = 5))
