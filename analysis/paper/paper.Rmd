...
```{r pca-analysis, fig.cap = "PCA biplot resulting from variables that have been related to mobility patterns. Note that details on the transformation of the variables has been left out of the plot for clarity, but follow those given in Figure 4.", fig.height = 8}
