...
duration <- c("9500–8250 BCE", "8250–6350 BCE", "6350–4650 BCE", "4650–3800 BCE", "9200–8200 BCE", "8200–7000 BCE", "7000–5600 BCE", "5600–4500 BCE", "4500–3900 BCE")
...
gt(df) %>% 
  ...
  tab_header(
    title = "Table 1. Chronological frameworks. Glørstad's (2004) divison of phases reflects the traditional and more established frameworks, to which Reitan (2016) has recently suggested considerable changes."
  ) %>% 
